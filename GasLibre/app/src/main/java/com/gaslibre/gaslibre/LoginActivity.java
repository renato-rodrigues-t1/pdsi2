...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    private UserController u= new UserController(this);
    ...
    private void test(){
        User userTemp= new User("Bruno Ernandes", "renato.rsufu@gmail.com", "1234@locura*");
    ...
    public void attemptLogin() {
        ...
        String usuarioEntrado= mEmailView.getText().toString();
        String senhaEntrada= mPasswordView.getText().toString();
        Log.v("USER", usuarioEntrado);
        Log.v("SENHA", senhaEntrada);
